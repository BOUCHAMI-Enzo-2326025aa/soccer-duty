...
export default function AdminSidebar({
  ...
  return (
    <>
      ...
      />
      <aside
        className={`fixed top-0 left-0 bottom-0 w-[240px] md:w-[230px] bg-navy flex flex-col z-[200] transition-transform duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] ${isOpen ? "translate-x-0" : "-translate-x-full md:translate-x-0"}`}
      >
        ...
        <div className="flex-1 overflow-y-auto pt-1.5">
          ...
          <Link
            ...
            className="flex items-center gap-2.5 px-4 py-[11px] cursor-pointer text-[13.5px] font-medium transition-all text-white/60 hover:text-white hover:bg-white/5"
          >
            <span className="text-base w-5 text-center shrink-0">❓</span> Aide
          </Link>
          <Link
